 ...
 */
final class Version20230320140022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE courrier ADD CONSTRAINT FK_BEF47CAAB3C12283 FOREIGN KEY (postal_situation_id) REFERENCES post (id)');
        $this->addSql('CREATE INDEX IDX_BEF47CAAB3C12283 ON courrier (postal_situation_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE courrier DROP FOREIGN KEY FK_BEF47CAAB3C12283');
        $this->addSql('DROP INDEX IDX_BEF47CAAB3C12283 ON courrier');
