 ...
 */
final class Version20230317001137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agent ADD post_id INT DEFAULT NULL, DROP post');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agent ADD post VARCHAR(255) NOT NULL, DROP post_id');
    }
}
